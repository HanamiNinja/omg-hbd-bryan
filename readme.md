...
## Core Concept
1. Fork the repo for each person (e.g., `omg-hbd-john`, `omg-hbd-paco`, `omg-hbd-kenji`)
2. Fill out `data.md` with person's details and desired language
3. Then use your favorite IDE/AI to generate the page just processing the `plan.md`
4. GitHub Actions workflow uses AI to generate personalized content in specified language
5. Astro builds a beautiful, animated static site
